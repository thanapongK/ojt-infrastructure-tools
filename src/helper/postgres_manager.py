...
class PostgresManager:
    ...
    def __init__(
        self, config=None, spark=None, table: str = PostgresConfiguration.TABLE
    ):
        ...
        Args:
            ...
            table: Table name (default from PostgresConfiguration.TABLE)
        """
        self.table = table
        ...
        try:
            ...
            if self._external_spark is not None:
                ...
                logging.getLogger(__name__).info(
                    "✓ PostgreSQL Manager using external Spark session"
                )
                return
